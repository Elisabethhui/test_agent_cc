...
- `modules.<name>.status`: Updated after module note generation.
- `modules.<name>.note_file`: Path to generated module note.
- `modules.<name>.last_processed_at`: ISO timestamp for last module-note run.